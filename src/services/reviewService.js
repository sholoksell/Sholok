...
export const reviewService = {
  ...
  submitReview: async ({ productId, rating, title, comment, images = [] }) => {
    const response = await api.post('/reviews', { productId, rating, title, comment, images });
  ...
  uploadImage: async (file) => {
    ...
    const response = await api.post('/reviews/upload-image', form, { headers: { 'Content-Type': 'multipart/form-data' } });
