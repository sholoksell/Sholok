// Phonetic Bangla (Avro-style) transliteration engine.
// Adapted from jsAvroPhonetic by Rifat Nabi / OmicronLab (MPL 1.1).
// Converts English phonetic keystrokes (e.g. 'ami banglay likhi') into Bangla Unicode.

export const avroPhoneticEngine = {
...
export function toBangla(input: string): string {
  return avroPhoneticEngine.parse(input);
}
