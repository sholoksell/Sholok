      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">{t('sholokTagline')}</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/account" className="hover:text-white">{t('trackOrder')}</Link></li>
              ...
              <li className="pt-1 border-t border-gray-700 mt-1">
                <Link to="/vendor/apply" className="hover:text-white text-yellow-400 font-semibold flex items-center gap-1">
                  🏪 {t('sellOnSholok')}
                </Link>
              </li>
            </ul>
