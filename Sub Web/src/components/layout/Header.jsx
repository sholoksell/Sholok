...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Bar */}
      <div className="container mx-auto px-4 py-2 md:py-3.5">
        <div className="flex items-center gap-3 md:gap-4 lg:gap-5">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <motion.div
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="hidden 2xl:flex items-center gap-2 bg-[#fec400] text-black px-3 py-1.5 rounded-sm text-xs font-bold cursor-pointer hover:bg-[#eebb00] transition-all duration-300 shadow-lg"
            >
              <motion.span
            ...
            {/* Sell on Sholok */}
            <Link to="/vendor/apply" className="hidden 2xl:flex items-center gap-1 text-yellow-300 hover:text-yellow-200 text-xs font-semibold border-r border-white/30 pr-3 transition-colors">
              🏪 Sell on Sholok
            </Link>
            ...
            <Link to={isAuthenticated ? '/account' : '/login'}>
              <motion.div
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="hidden md:flex items-center gap-2 text-white hover:bg-white/10 px-2 xl:px-3 py-1.5 rounded transition-all duration-300"
              >
      ...
      {/* MegaMenu — category nav bar, desktop only */}
      ...
      {/* Mobile Search Bar */}
      <motion.div
        className="md:hidden px-3 pb-3 pt-1"
