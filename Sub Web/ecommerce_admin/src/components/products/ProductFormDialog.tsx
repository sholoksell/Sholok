              ...
              <TabsContent value="general" className="space-y-4 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('productNameBn')}</FormLabel>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('shortDescBn')}</FormLabel>
                      <FormControl>
                        <Textarea
                          {...field}
                          rows={2}
                          placeholder="সংক্ষিপ্ত বিবরণ বাংলায় লিখুন..."
                ...
                <div>
                  <p className="text-sm font-medium mb-2">{t('descriptionBn')}</p>
                  <div className="bg-secondary/50 rounded-md border border-border">
                    <ReactQuill
                      theme="snow"
                      value={descriptionBn}
                      ...
                      modules={modules}
                      formats={formats}
                      placeholder="বাংলায় বিস্তারিত বিবরণ লিখুন..."
                      className="text-foreground min-h-[150px]"
                    />
                  </div>
                </div>
