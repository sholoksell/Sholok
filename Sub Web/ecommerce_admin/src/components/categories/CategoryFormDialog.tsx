...
export default function CategoryFormDialog({ open, onOpenChange, category, defaultParentId = null }: Props) {
  ...
  }, [category, defaultParentId, form, categories.length]);
  ...
  const onSubmit = async (data: CategoryFormData) => {
    ...
    try {
      ...
      } else if (msg.toLowerCase().includes('slug already exists')) {
              ...
              <TabsContent value="general" className="space-y-4 mt-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Category Name (বাংলা)</FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            className="bg-secondary border-border"
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="e.g. grocery, food, rice, oil"
                          className="bg-secondary border-border"
                        />
                      </FormControl>
                      <FormMessage />
