            ...
            <div className="border border-border rounded-lg p-4 space-y-4 bg-secondary/30">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-muted-foreground">{t('statusVisibility')}</label>
                  <select
                    value={statusFilter}
                ...
                {/* Stock Status */}
                <div className="space-y-1">
                  <label className="text-xs font-medium text-muted-foreground">{t('stockStatus')}</label>
                  <select
                    value={stockFilter}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {product.isNew && <Badge className="bg-primary/20 text-primary border-0 text-xs">{t('newBadge')}</Badge>}
                        </div>
