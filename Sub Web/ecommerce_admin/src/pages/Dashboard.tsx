    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 glass-card border-border">
          <CardHeader>
            <CardTitle className="text-foreground">{t('revenueOverview')}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-card border-border">
          <CardHeader>
            <CardTitle className="text-foreground">{t('salesByCategory')}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="glass-card border-border">
          <CardHeader>
            <CardTitle className="text-foreground">{t('ordersTrend')}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-card border-border">
          <CardHeader>
            <CardTitle className="text-foreground">{t('recentOrders')}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {ordersLoading ? (
                <p className="text-sm text-muted-foreground text-center py-4">{t('loadingOrders')}</p>
