  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-3xl font-bold">{t('homePageProduct')}</h1>
          <p className="text-muted-foreground">{t('manageHomepageSections')}</p>
        </div>
        <div className="flex gap-2 flex-wrap">
          ...
          <Button variant="outline" onClick={handleSeedDefaults}>
            <Sparkles className="w-4 h-4 mr-1" /> {t('seedDefaultSections')}
          </Button>
          <Button variant="outline" onClick={ensureProductDetailSections}>
            <Sparkles className="w-4 h-4 mr-1" /> {t('addProductDetailSections')}
          </Button>
                ...
                {isOpen && (
                  <CardContent className="space-y-3">
                    <div className="flex justify-end">
                      ...
                      >
                        <Plus className="w-4 h-4 mr-1" /> {t('addProduct')}
                      </Button>
                    </div>
      ...
      <Dialog open={sectionDialogOpen} onOpenChange={setSectionDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editingSectionId ? t('editSection') : t('newSection')}
            </DialogTitle>
            <DialogDescription>
              {t('configureSection')}
            </DialogDescription>
          ...
          <DialogFooter>
            ...
            <Button onClick={saveSection}>{t('save')}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={productDialogOpen} onOpenChange={setProductDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editingProductId ? t('editProductEntry') : t('addProduct')}
            </DialogTitle>
            <DialogDescription>
              {t('productEntryDesc')}
            </DialogDescription>
