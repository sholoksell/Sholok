...
const mapApiProduct = (apiProd: ApiProduct): Product => ({
  ...
  shortDescriptionBn: apiProd.shortDescriptionBn || '',
  categoryId: (apiProd.categoryId && typeof apiProd.categoryId === 'object')
    ? String((apiProd.categoryId as any)._id)
    : (apiProd.categoryId ? String(apiProd.categoryId) : null),
  brand: '',
  ...
  barcode: '',
  stock: apiProd.stock,
  lowStockThreshold: apiProd.lowStockThreshold ?? 10,
  weight: 0,
...
export const useProductStore = create<ProductState>()((set) => ({
  ...
  updateProduct: async (id, updates) => {
    try {
      ...
      if (updates.shortDescriptionBn !== undefined) updateData.shortDescriptionBn = updates.shortDescriptionBn;
