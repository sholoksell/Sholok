// ====================== MOCK DATA - Bangladesh Job Portal ======================
...
export const companies = [
  {
    ...
    description:
      "গ্রামীণফোন বাংলাদেশের শীর্ষস্থানীয় টেলিযোগাযোগ কোম্পানি। আমরা ডিজিটাল বাংলাদেশ গড়ার স্বপ্ন নিয়ে কাজ করি।",
  ...
  },
  {
    ...
    website: "brac.net",
    description:
      "ব্র্যাক বিশ্বের বৃহত্তম এনজিও। আমরা দারিদ্র্য বিমোচন, শিক্ষা ও স্বাস্থ্য খাতে কাজ করি।",
  ...
  },
  {
    ...
    description:
      "ডাচ-বাংলা ব্যাংক বাংলাদেশের অন্যতম শীর্ষ বেসরকারি বাণিজ্যিক ব্যাংক। আমরা প্রযুক্তিগত উদ্ভাবনে পথিকৃৎ।",
  ...
  },
  {
    ...
    website: "shajgoj.com",
    description:
      "শাজগোজ বাংলাদেশের সর্ববৃহৎ বিউটি ও স্কিনকেয়ার ই-কমার্স প্ল্যাটফর্ম। আমরা নারীদের সৌন্দর্য চর্চায় সহায়তা করি।",
  ...
  },
  {
    ...
    description:
      "স্কয়ার ফার্মাসিউটিক্যালস বাংলাদেশের শীর্ষ ফার্মাসিউটিক্যাল কোম্পানি। আমরা মানসম্পন্ন ওষুধ উৎপাদন করি।",
  ...
  },
  {
    ...
    website: "chaldal.com",
    description:
      "চালডাল বাংলাদেশের প্রথম অনলাইন গ্রোসারি শপ। আমরা প্রযুক্তি ব্যবহার করে মানুষের জীবনযাত্রা সহজ করছি।",
...
export const categories = [
  { id: "all", label: "সকল", count: jobs.length },
  { id: "প্রযুক্তি", label: "প্রযুক্তি", count: jobs.filter(j => j.category === "প্রযুক্তি").length },
  { id: "মার্কেটিং", label: "মার্কেটিং", count: jobs.filter(j => j.category === "মার্কেটিং").length },
  { id: "ব্যাংকিং", label: "ব্যাংকিং", count: jobs.filter(j => j.category === "ব্যাংকিং").length },
  { id: "এনজিও / উন্নয়ন", label: "এনজিও", count: jobs.filter(j => j.category === "এনজিও / উন্নয়ন").length },
  { id: "ফার্মা / স্বাস্থ্য", label: "ফার্মা", count: jobs.filter(j => j.category === "ফার্মা / স্বাস্থ্য").length },
  { id: "ডিজাইন", label: "ডিজাইন", count: jobs.filter(j => j.category === "ডিজাইন").length },
  { id: "এইচআর", label: "এইচআর", count: jobs.filter(j => j.category === "এইচআর").length },
];

export const locations = ["ঢাকা", "চট্টগ্রাম", "সিলেট", "রাজশাহী", "খুলনা", "বরিশাল", "রংপুর", "ময়মনসিংহ"];
