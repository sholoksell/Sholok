...
async function listCategories() {
  try {
    ...
    console.log('📂 Searching for snacks and sweets related categories:\n');
    
    const patterns = [/snack/i, /biscuit/i, /cookie/i, /chip/i, /crisp/i, /chocolate/i, /candy/i, /sweet/i, /cake/i, /pastry/i, /wafer/i];
