            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-20">
                  ...
                  <p className="text-sm text-muted-foreground max-w-xs">Add items you love and they'll appear here. We'll save them for you.</p>
                </div>
              ) : (
                  ...
                  {items.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h4 className="text-sm font-semibold line-clamp-2 mb-1">{item.name}</h4>
            ...
            {items.length > 0 && (
              <footer className="p-6 border-t border-border space-y-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-accent-mint">Free</span>
                </div>
